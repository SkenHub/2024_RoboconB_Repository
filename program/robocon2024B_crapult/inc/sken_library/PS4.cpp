...
void PS4::StartRecive(Pin tx_pin,Pin rx_pin,UartNumber uart_num){
	serial.init(tx_pin,rx_pin,uart_num,19200);
...
bool PS4::Getdata(PS4_data* ps4_data){
	...
	/*
	ps4_data->Right    = false;
	ps4_data->Down     = false;
	ps4_data->Left     = false;
	ps4_data->Up       = false;
	ps4_data->Square   = false;
	ps4_data->Cross    = false;
	ps4_data->Circle   = false;
	ps4_data->Triangle = false;
	ps4_data->L1       = false;
	ps4_data->R1       = false;
	ps4_data->L2       = false;
	ps4_data->R2       = false;
	ps4_data->Share    = false;
	ps4_data->Options  = false;
	ps4_data->Ps       = false;
	ps4_data->Pad      = false;
	ps4_data->LxPad    = 0;
	ps4_data->LyPad    = 0;
